...
export const categoryEnhancements = {
  memory: {
    ...
    science: "Holding information, then retrieving it intact",
  ...
  attention: {
    ...
    science: "Sustaining focus while filtering out what does not matter",
  ...
  speed: {
    ...
    science: "Responding accurately while the clock is against you",
  ...
  logic: {
    ...
    science: "Finding the rule, then applying it under constraint",
  ...
  language: {
    ...
    science: "Retrieving and rearranging words at speed",
  ...
  multi: {
    ...
    science: "Holding two demands at once and switching between them",
  ...
  competitive: {
    ...
    science: "The same demands, against another person’s pace",
